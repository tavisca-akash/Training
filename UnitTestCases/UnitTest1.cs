...
namespace UnitTestCases
{
    ...
    public class UnitTest1
    {
       ...
       public void HrLoginTest()
       {
           ...
           Assert.AreEqual(currentURL, "http://localhost:49909/HrPage.aspx");
       }
       ...
       public void LogoutSuccessfullTest()
       {
           ...
           Assert.AreEqual(currentURL, "http://localhost:49909/Login.aspx");
       ...
       public void EmployeeLoginTest()
       {
           ...
           Assert.AreEqual(currentURL, "http://localhost:49909/EmployeePage.aspx");
