<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HRHeader.ascx.cs" Inherits="EMSWidgets.HRHeader" %>
...
<asp:Panel ID="pnlSettings" runat="server" Visible="true">
    ...
    <a href="HRAddEmployee">AddEmployee</a>
    <a href="HRAddRemark">AddRemark</a>
