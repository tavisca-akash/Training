...
/* header column rules */
.grid th { /*background: url(WebResource.axd?d=OsiLIrSVp9b6pTdTyk-HCmtXZPLag11OJ0W7mbyfRK7abLgBdiUqXFgLEszmcbHe6UJZVG-eEboU9xQluAfqy3wNGlYGEm9fqRfIFYIh9FAH6UntT-iu4xt135rlkBj3m4L9q4YQLL2ub7uRQl0AeXyNWaNo-ec6hA1vZalkPdpML0aw0&t=635748102170000000) repeat-x 0px 0px;*/ background: #ecf3f7; border-bottom: 1px solid #d0dff4; /*	border-color: #989898 #cbcbcb #989898 #989898;     border-style: none;     border-width: 1px 1px 1px medium; 	padding: 4px 5px 2px 10px;*/ color: #333; font-weight: bold; }
...
.grid .altrow:hover { background-color: #FFFFCC; border-bottom: 1px solid #d0dff4;}
.grid .row { background-color: #fff; border-bottom: 1px solid #d0dff4; }
.grid .row:hover { background-color: #FFFFCC; border-bottom: 1px solid #d0dff4;}
